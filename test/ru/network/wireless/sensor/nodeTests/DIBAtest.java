...
//        Node node_105 = createDummyNode(1, 14);
//        Node node_106 = createDummyNode(1, 15);
        ...
        Assert.assertEquals(4, node_81.getRoutingItems().size());
        ...
        Assert.assertEquals(1, node_95.getRoutingItems().size());
